...
# 加载宜居指数数据
df = pd.read_csv(r"..\dataset\map2017.csv")
...
# 使用 colorbar() 手动调整位置
sm = plt.cm.ScalarMappable(cmap=cmap, norm=plt.Normalize(vmin=75, vmax=210))
...
# 保存图像为 PNG
output_path = r'C:\Users\m1527\Desktop\GT\map2017.png'  # 输出路径
